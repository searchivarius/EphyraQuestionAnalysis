 ...
 * 
 * @author Guido Sautter, Nico Schlaefer, Leonid Boytsov
 * @version 2014-07
 */
public class StanfordNeTagger {
	...
	public static HashMap<String, String[]> extractNEs(String sentence) {
		...
		String neString = "";
		try {
			neString = classifier.classifyToString(sentence);
		} catch (Exception e) {
	...
	public static void main(String args[]) {
	  if (!init()) {
	    System.err.println("Failed to init from the default location");
	    return;
	  }
	  ...
	  for (Map.Entry<String,String[]> elem: res.entrySet()) {
	    ...
	    for (String s: elem.getValue()) System.out.print(s + " ");
	    System.out.println();
	  }
