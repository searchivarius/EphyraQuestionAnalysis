...
public class QuestionAnalysis {
    ...
    public static void main (String[] args) throws Exception {
      if (args.length != 1) {
        System.out.println("USAGE: QuestionAnalysis <inputQuestionsFile>");
        System.out.println("Output stored in: <inputQuestionsFile>.atype");
        System.exit(0);
      }     
    
      List<String> questions = new ArrayList<String> ();
      BufferedReader in = new BufferedReader(new FileReader(args[0]));
      BufferedWriter out = new BufferedWriter(new FileWriter(args[0]+".atype"));
      String question;
