...
public class FocusFinder {
    ...
    public static void initialize() throws Exception {
        ...
        if (!JWNL.isInitialized()) {
            String file_properties = properties.getProperty("jwnl.configuration");
            if (file_properties == null) file_properties = System.getProperty("jwnl.configuration");
    ...
    public static void main(String[] args) throws Exception {
       if (args.length != 1) {
           ...
           System.out.println("Output stored in: <inputQuestionsFile>.focus");
           System.exit(0);
       }
       ...
       BufferedWriter out = new BufferedWriter(new FileWriter(args[0]+".focus"));
       String question;
